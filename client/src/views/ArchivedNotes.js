...
const ArchivedNotes = () => {
    ...
    return (
        <>
            <Header />
            <Col>
              <h1 className="d-flex align-items-center justify-content-center">Notas archivadas</h1>
              <Button onClick={() => navigate('/')} className="mt-2 w-50" variant="primary">Regresar a Inicio</Button>
